#!/usr/bin/env python3
"""
Script for detecting and removing duplicates in unpacked ZIP folders
"""
...
def process_folders(directory, dry_run=True):
    ...
    if dry_run:
        ...
        print()
        print("💡 To actually delete the duplicates, rerun with --execute flag:")
        print("   python delete-dupes.py --execute")
    else:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Detect and remove duplicates in unpacked ZIP folders',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python delete-dupes.py              # Dry run (preview only)
  python delete-dupes.py --execute    # Actually delete duplicates
        """
    )
    parser.add_argument(
        '--execute',
    ...
    if dry_run:
        print("⚠️  DRY RUN MODE - Preview only, no changes will be made")
        print()
    else:
